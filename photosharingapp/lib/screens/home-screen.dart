...
class _HomeScreenState extends State<HomeScreen>{
  ...
  Future<List<Post>> loadPosts() async{
    print("called");
    var url=Uri.parse("http://192.168.1.7:6000/posts");
    var response=await http.get(url);
    var result=jsonDecode(response.body);
    postList=[];
    result.forEach((e){
      postList.add(Post(username: e["userName"], postUrl: "http://192.168.1.7:6000/post/${e["_id"]}", likes: e["likes"], caption: e["caption"],id:e["_id"]));
    });
    return postList;
  }
